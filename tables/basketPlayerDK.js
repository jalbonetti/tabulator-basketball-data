...
// Based on basketPlayerDDTD.js with column modifications for DFS stats
...
export class BasketPlayerDKTable extends BaseTable {
    ...
    expandNameColumnToFill() {
        ...
        if (remainingSpace > 0) {
            ...
            if (nameColumn) {
                ...
                console.log(`DK DFS Name column expanded by ${remainingSpace}px to fill container`);
            }
        }
    }
    ...
    createSubtableContent(container, data) {
        ...
        // Player DK Point % stats (convert decimals to percentages)
        ...
        // Opponent DK Point % stats (convert decimals to percentages)
