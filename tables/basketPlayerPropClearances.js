...
// - FIXED: Player Name column width - stores minimum width and ensures it's always applied
...
export class BasketPlayerPropClearancesTable extends BaseTable {
        ...
        this.table.on("tableBuilt", () => {
            ...
            setTimeout(() => {
                ...
                if (rowCount > 0) {
                    ...
                    // ADDED: Ensure Name column width is correct after all calculations
    ...
    ensureNameColumnWidth() {
        ...
        if (nameColumn) {
            ...
            if (currentWidth < NAME_COLUMN_MIN_WIDTH) {
                console.log(`Prop Clearances: Setting Name column from ${currentWidth}px to ${NAME_COLUMN_MIN_WIDTH}px`);
    ...
    // ADDED: Force width recalculation - called by TabManager on tab switch
    forceRecalculateWidths() {
        console.log('Prop Clearances forceRecalculateWidths called');
    ...
    calculateAndApplyWidths() {
        ...
        if (isSmallScreen) {
            ...
            console.log(`Mobile/tablet mode: container widths cleared, Name column preserved`);
            return;
        }
