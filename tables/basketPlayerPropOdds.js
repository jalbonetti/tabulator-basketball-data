...
export class BasketPlayerPropOddsTable extends BaseTable {
    ...
    scanDataForMaxWidths(data) {
        ...
        longBestBooksExamples.forEach(example => {
            ...
            if (exampleWidth > maxWidths["Player Best Odds Books"]) {
                maxWidths["Player Best Odds Books"] = exampleWidth;
            }
        });
        console.log(`Player Prop Odds: Best Books max width from data/examples: ${Math.ceil(maxWidths["Player Best Odds Books"])}px`);
            ...
            if (column) {
                ...
                if (headerTitle) {
                    ...
                    if (headerTextWidth > maxWidths[field]) {
                        ...
                        console.log(`Player Prop Odds: Header "${headerTitle}" wider than data for ${field}`);
                    }
                }
            }
        });
